  ...
  return (
    <>
      ...
      className='flex mt-[200px] font-sans flex-col p-[65px 50px] gap-14 justify-center items-center'>
        ...
        <motion.p variants={textVariant()} className='xs:mt-[10px] sm:mt-[10px] text-center md:mt-3 text-20px sm:w-[411px]sm:h-[90px] flex'>We focus on ergonomics and meeting you where you work. It's only a keystroke away.</motion.p>
