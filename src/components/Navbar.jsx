  ...
  return (
    <>
      ...
      {/* mobile navbar */}
        ...
        <nav className='z-10 md:hidden flex justify-center 2-[90vw] fixed'>
            <div className="pt-5 px-2 flex justify-around">
                <div className="w-[40%]">
                    <img src={logo} alt="" className='w-[100%] pt-2'/>
                </div>
                <button className='w-[130px] h-[45px] bg-black rounded-[3px] border-[1px] mt-2'>Login</button>
        ...
        <AnimatePresence>
            {isMenuOpen && (
                ...
                className="nav-container md:hidden border flex flex-col fixed text-white w-[55vw] mt-[120px] h-[350px] justify-around items-end pr-[18vw] ml-[28%] z-10 rounded-2x1 pt-4">
                    ...
                    className="w-[150px] h-[48px] text-black bg-white font-bold rounded-x1 mb-7 text-[14px] mr-[-2.8em]"
                    >
                        Get Started
                    </motion.button>
                </motion.div>
